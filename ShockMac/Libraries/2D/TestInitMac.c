...
#ifndef __powerp__
// ------- this ShockTask is also in initMac.h, and this one is not for PowerPC.
...
void ShockTicksProc(void)
{
	for (;;)
	{	
		gShockTicks++;
		// DoIO( (struct IORequest *) timeReq ); ????	// need create timeReq etc...
	}
}
